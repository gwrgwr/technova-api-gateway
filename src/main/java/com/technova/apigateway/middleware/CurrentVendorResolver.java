...
@Component
public class CurrentVendorResolver implements HandlerMethodArgumentResolver {
    private final JwtUtils jwtUtils;

    public CurrentVendorResolver(JwtUtils jwtUtils) {
        this.jwtUtils = jwtUtils;
    }

    @Override
    public boolean supportsParameter(MethodParameter parameter) {
        return parameter.hasParameterAnnotation(CurrentVendor.class) && // Verifica se o parâmetro tem a anotação @CurrentUserId
    ...
    public Object resolveArgument(MethodParameter parameter, ModelAndViewContainer mavContainer,
        ...
        return jwtUtils.getCurrentVendor();
    }
}
